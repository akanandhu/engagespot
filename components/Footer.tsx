    ...
    <div className='mx-auto max-w-9xl  pt-[3.4rem] pl-[1.6rem] pb-[1.5rem] pr-[6.5rem] '>
             <div className='flex flex-col'>
                ...
                <div>
                            ...
                            <div className='flex gap-6'>
                                <Image className=' cursor-pointer' alt='linkedin' src={linkedin} height={26} width={26} />
                                <Image className=' cursor-pointer' alt='twitter' src={twitter} height={21} width={26} />
                ...
                <div className='flex  gap-12 pt-[4rem] pl-[6.8rem] text-xl '>
                        <div className='text-white font-poppins '>
                            ...
                            <ul className=' cursor-pointer font-normal pb-[1rem]'>React Notifications</ul>
                            <ul className=' cursor-pointer font-normal pb-[1rem]'>Notification UI kit</ul>
                            <ul className=' cursor-pointer font-normal pb-[1rem]'>Features</ul>
                            <ul className=' cursor-pointer font-normal pb-[1rem]'>Disposabel email Detector</ul>
             ...
             <div>
                        ...
                        <div className='flex text-white font-poppins pt-[1.25rem] pl-[5.35rem] '>
                            ...
                            <div className=' cursor-pointer pr-[1.85rem]'>Terms and Conditions</div>
